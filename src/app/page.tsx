      ...
      <section className="relative min-h-[92vh] flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 py-16 lg:w-1/2 bg-white">
          ...
          <div className="flex flex-wrap gap-3 mb-12">
            ...
            <Link href="/portfolio">
              <Button size="lg" variant="outline" className="rounded-full px-8">Design Portfolio</Button>
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-1">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">We handle both premium plot sales and world-class interior design — your journey from empty land to dream space is seamless.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-slate-900 mt-2 mb-4">Let's Find Your<br />Perfect Plot</h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: MapPin, label: 'Office', value: '123 Main Street, City Centre' },
